...
class Board_Storage_Ctrl_Panel(wx.Panel):
    def __init__(self, parent, log):
        ...
        panel7 = wx.Panel(panel, -1, style=wx.RAISED_BORDER)
        panel8 = wx.Panel(panel, -1, style=wx.RAISED_BORDER)
        ...
        self.SpeedWindow1.SetMiddleText("18mm")
        # Assign The Colour To The Center Text
        self.SpeedWindow1.SetMiddleTextColour(wx.GREEN)
        ...
        self.SpeedWindow5.SetMiddleText("20mm")
        self.SpeedWindow5.SetMiddleTextColour(wx.GREEN)
        ...
        font=wx.Font(6, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD)
        font=font.MakeSmaller()
        font=font.MakeSmaller()
        font=font.MakeSmaller()
        self.SpeedWindow6.SetTicksFont(font)
        ...
        led = gizmos.LEDNumberCtrl(panel7, -1,size=(200,50))
        led.SetValue("012.34")
        bsizer7.Add(led,1)
        led = gizmos.LEDNumberCtrl(panel7, -1,size=(200,50))
        led.SetValue("56789")
